...
_TROUBLE_BREWING_NIGHT_ORDER: tuple[NightOrderSpec, ...] = (
    NightOrderSpec(
        ...
        True,
        "每晚先决定一名中毒目标。",
        "Acts each night to poison one player.",
    ),
    NightOrderSpec(
        "monk",
        21,
        ...
        True,
        "除首夜外，每晚保护一名其他玩家。",
        "Acts each night except the first to protect another player.",
    ),
    NightOrderSpec(
        "scarlet_woman",
        23,
        ...
        "special_reaction",
        False,
        "恶魔死亡且仍有 5 名或更多存活玩家时立即接管。",
        "Triggers immediately on demon death while 5+ players live.",
    ),
    NightOrderSpec(
        "imp",
        24,
        ...
        True,
        "除首夜外，每晚选择一名玩家击杀。",
        "Acts each night except the first to kill a player.",
    ),
    NightOrderSpec(
        "washerwoman",
        34,
        ...
        False,
        "首夜获得两名玩家中一名是真村民的信息。",
        "Receives first-night information about a townsfolk.",
    ),
    NightOrderSpec(
        "librarian",
        35,
        ...
        False,
        "首夜获得外来者信息。",
        "Receives first-night outsider information.",
    ),
    NightOrderSpec(
        "investigator",
        36,
        ...
        False,
        "首夜获得爪牙信息。",
        "Receives first-night minion information.",
    ),
    NightOrderSpec(
        "chef",
        37,
        ...
        False,
        "首夜得知相邻邪恶玩家对数。",
        "Receives first-night adjacent evil pair count.",
    ),
    NightOrderSpec(
        "empath",
        50,
        ...
        False,
        "每晚得知相邻活人中的邪恶人数。",
        "Receives adjacent evil count each night.",
    ),
    NightOrderSpec(
        "undertaker",
        52,
        ...
        False,
        "每晚得知当天被处决者的身份。",
        "Receives the executed player's role each night.",
    ),
    NightOrderSpec(
        "fortune_teller",
        55,
        ...
        True,
        "每晚选择两名玩家，判断其中是否有恶魔。",
        "Chooses two players each night to detect a demon.",
    ),
    NightOrderSpec(
        "ravenkeeper",
        58,
        ...
        True,
        "若在夜晚死亡，当晚得知一名玩家身份。",
        "If killed at night, learns one player's role that night.",
    ),
    NightOrderSpec(
        "butler",
        70,
        ...
        True,
        "每晚绑定一名玩家，次日投票受限。",
        "Chooses a player each night, constraining next day's vote.",
    ),
    NightOrderSpec(
        "spy",
        70,
        ...
        "each_night",
        False,
        "每晚查看魔典。与管家同一顺位时，按规则书顺序先管家后间谍。",
        "Views the grimoire each night. If tied with Butler, Butler is processed first.",
    ),
)
...
def get_night_order_sort_key(
    role_id: str, fallback_order: int, seat_index: int = 0
) -> tuple[int, int, int]:
