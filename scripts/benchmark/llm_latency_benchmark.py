...
Examples:
  .\.venv\Scripts\python.exe scripts\benchmark\llm_latency_benchmark.py --samples 3
  .\.venv\Scripts\python.exe scripts\benchmark\llm_latency_benchmark.py --samples 5 --prompt-set speech
"""
