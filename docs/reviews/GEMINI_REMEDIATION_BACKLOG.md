...
**相关文件**:
- [game_loop.py](../../src/orchestrator/game_loop.py)
...
**相关文件**:
- [base_agent.py](../../src/agents/base_agent.py)
- [ai_agent.py](../../src/agents/ai_agent.py)
- [working_memory.py](../../src/agents/memory/working_memory.py)
- [game_loop.py](../../src/orchestrator/game_loop.py)
- [test_agent_reasoning.py](../../tests/test_agents/test_agent_reasoning.py)
- [test_memory.py](../../tests/test_agents/test_memory.py)
...
**相关文件**:
- [HANDOVER_ALPHA_0.2.md](HANDOVER_ALPHA_0.2.md)
- [wave-3-task-board.md](../plans/alpha-0.2-plan/wave-3-task-board.md)
...
**相关文件**:
- [wave3_acceptance.py](../../scripts/acceptance/wave3_acceptance.py)
- [ai_eval_acceptance.py](../../scripts/acceptance/ai_eval_acceptance.py)
- [test_wave3_acceptance.py](../../tests/test_orchestrator/test_wave3_acceptance.py)
...
**相关文件**:
- [ai_evaluation.py](../../scripts/acceptance/ai_evaluation.py)
- [test_ai_evaluation.py](../../tests/test_orchestrator/test_ai_evaluation.py)
...
- [base_agent.py](../../src/agents/base_agent.py)
- [ai_agent.py](../../src/agents/ai_agent.py)
- [game_state.py](../../src/state/game_state.py)
- [information_broker.py](../../src/orchestrator/information_broker.py)
- [game_loop.py](../../src/orchestrator/game_loop.py)
