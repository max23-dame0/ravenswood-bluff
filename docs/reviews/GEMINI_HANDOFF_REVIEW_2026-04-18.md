---
doc_id: "REV-002"
title: "Gemini 移交文档复核记录（2026-04-18）"
category: "review"
role: "[Delta]"
status: "published"
date: "2026-04-21"
...
- `_pending_night_action` 已真实存在于 [game_loop.py](../../src/orchestrator/game_loop.py)
...
- [phase_manager.py](../../src/engine/phase_manager.py) 当前逻辑已经实现：
...
- [test_role_skill_audit.py](../../tests/test_engine/test_role_skill_audit.py)
- [test_high_risk_roles.py](../../tests/test_engine/test_high_risk_roles.py)
...
- [outsiders.py](../../src/engine/roles/outsiders.py)
